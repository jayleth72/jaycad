 ...
 * {@link ConversionsMenuFragment.ConversionsMenuInteractionListener} interface
...
public class ConversionsMenuFragment extends Fragment {
     ...
     * @return A new instance of fragment ConversionsMenuFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ConversionsMenuFragment newInstance(String param1, String param2) {
        ConversionsMenuFragment fragment = new ConversionsMenuFragment();
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onConversionsMenuInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ConversionsMenuInteractionListener) {
            mListener = (ConversionsMenuInteractionListener) context;
        } else {
